    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-10">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 font-josefin">
            ...
            <div class="card border border-gray-100 shadow-lg">
                <div class="card-body">
                    <div class="card-title">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-12 w-12 text-yellow-500" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
